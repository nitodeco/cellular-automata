...
export const PerformancePanel = (props: Props) => {
	return (
		<div class="absolute top-4 right-4 bg-black/50 backdrop-blur-sm text-white p-3 rounded-lg font-mono text-xs z-20 border border-white/10 shadow-lg pointer-events-none select-none">
